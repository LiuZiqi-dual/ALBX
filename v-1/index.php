<?php 
  ...
  //__DIR__为PHP5.3中新增的魔术常量，可以获取指向文件的父文件夹路径
  //连接数据库
  $connect = connect('127.0.0.1','root','root','baixiu');
  //执行sql语句
        ...
        <div class="entry">
          ...
          <div class="main">
            ...
            <p class="extra">
              ...
              <span class="comment">评论(230)</span>
